        ...
        <script type="text/javascript">
            ...
            function convertHTMLToCSVAndDownload() {
                ...
                memeDivs.forEach(memeDiv => {
                    console.log(memeDiv)
                    let author = memeDiv.querySelector('.memeauthor').innerHtml;
                    let title = memeDiv.querySelector('.title').innerHtml;
                    let url = memeDiv.querySelector('.memeurl').innerHtml;
                    let subreddit = memeDiv.querySelector('.memesub').innerHtml;
                    let upvotes = memeDiv.querySelector('.upvotes').innerHtml;
                    let sentiment = memeDiv.querySelector('.sentiment').innerHtml;
                    let sentimentLabel = memeDiv.querySelector('.sentiment-label').innerHtml;
